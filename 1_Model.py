...
#Get the stock quote
df = web.DataReader('TSLA', data_source='yahoo', start='2012-01-01', end='2022-07-09')
...
plt.title('Closing Prce History')
plt.plot(df['Close'])
...
if not os.path.exists('path_desktop'):
    ...
    #Save model
    model.save('path_desktop')
else:
    model = load_model('path_desktop')
...
#Get the quote
apple_quote = web.DataReader('TSLA', data_source='yahoo', start='2022-07-10', end='2022-07-10')
